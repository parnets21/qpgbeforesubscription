...
async getFilterOptions(req, res) {
  ...
  async getQuestionByClasswise(req, res) {
    try {
      ...
      console.log("=== Request Data ===");
      console.log("Total Blueprint Entries:", AllChapter?.length);
      ...
      console.log("Unique Chapters:", ChapterData.length);
      console.log("Unique Objectives:", ObjectiveData.length);
      console.log("Unique Question Types:", QueationTypeA.length);
      ...
      let selectedQuestions = [];
      let usedQuestionIds = new Set(); // Track used question IDs to avoid duplicates
      ...
      if (allQuestions.length !== 0) {
        ...
        for (const chapterConfig of AllChapter) {
          ...
          console.log(`\n=== Processing Blueprint Entry ===`);
          console.log(`Chapter: ${Blueprintchapter}`);
          console.log(`Objective: ${Blueprintobjective}`);
          console.log(`Type: ${BluePrintQuestiontype}`);
          console.log(`Required: ${questionsNeeded}`);
          
          if (questionsNeeded > 0) {
            // Get allowed question types for this blueprint type
            const allowedTypes = mapBlueprintTypeToDBType(BluePrintQuestiontype, marks);
            console.log(`  Allowed DB types:`, allowedTypes);
            
            // Filter questions for this specific chapter, objective, and question type
            // Also exclude already used questions
            let filteredQuestions = allQuestions.filter((item) => {
              // Skip if already used
              if (usedQuestionIds.has(item._id.toString())) {
                return false;
              }
            ...
            console.log(`  Available (exact match): ${filteredQuestions.length}`);
            ...
            if (filteredQuestions.length === 0 && label && label.length > 0) {
              ...
              console.log(`  Available (no lesson): ${filteredQuestions.length}`);
            }
            ...
            if (filteredQuestions.length === 0) {
              ...
              console.log(`  Available (no type): ${filteredQuestions.length}`);
            }
            ...
            if (filteredQuestions.length === 0) {
              ...
              console.log(`  Available (chapter only): ${filteredQuestions.length}`);
            }
            ...
            if (selected.length > 0) {
              ...
              console.log(`  Types selected:`, typeBreakdown);
            }
      ...
      console.log("\n=== Final Result ===");
      console.log("Blueprint entries:", AllChapter?.length);
